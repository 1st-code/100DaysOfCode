...
class CarManager:
    ...
    def move(self):
        ...
        for car in self.cars:
            ...
            if car["car"].ycor() in SLOW_LANE:
                car["car"].forward(self.MOVE_INCREMENT * 0.65)
            else:
    ...
    def reset_cars(self):
        ...
        for car in self.cars:
            if car["car"].xcor() < -330 or car["car"].xcor() > 520:
                car["car"].hideturtle()
    ...
    def check_overlap(self):
        ...
        for car in self.cars:
            ...
            for other_car in self.cars:
                other_car_x, other_car_y = other_car["car"].position()
                if car != other_car:
                    if car["car"].distance(other_car["car"]) < 40 and (car_y == other_car_y):
